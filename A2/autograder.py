...
def set_timeout(seconds):
    if hasattr(signal, 'SIGALRM'):
        ...
        # On platforms like Windows where SIGALRM is not available,
        # we simply do not enforce a timeout.
        print("Warning: Timeout not supported on this platform; continuing without timeout.")
